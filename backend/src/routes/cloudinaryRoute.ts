...
import { uploadFiles, uploadProfile } from "../controllers/cloudinary.controller";
...
router.post("/upload-profile/:profile_id", requireAuth, upload.single('image'), uploadProfile);
