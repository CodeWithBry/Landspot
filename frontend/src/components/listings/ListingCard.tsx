    ...
    <div className="md:flex-row flex flex-col gap-2 w-full px-5 py-3 text-serif border-2 rounded-xl border-primary-300 hover:border-primary-600">
      ...
      <div className="md:flex-row flex flex-col w-full">
        ...
        <div className="flex gap-2 md:w-fit w-full">
          <button className="md:w-fit w-full h-fit border-2 border-accent-400 text-accent-400 hover:bg-accent-400 hover:text-white transition text-md font-serif py-3 px-5 rounded-md cursor-pointer active:bg-accent-600">Edit</button>
          <button className="md:w-fit w-full h-fit border-2 border-danger-500 text-danger-500 hover:bg-danger-500 hover:text-white transition text-md font-serif py-3 px-5 rounded-md cursor-pointer active:bg-accent-600">Delete</button>
        </div>
      </div>
    </div>
  )
