import { UseListingType } from "@/hooks/useListings";
import { Listing } from "@/types/ListingType"
import Link from "next/link";

function MyListingCard({ listing, deleteFromListing }: { listing: Listing, deleteFromListing?: UseListingType["deleteFromListing"] }) {
  const imageStyle = {
