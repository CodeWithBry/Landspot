...
function AddListing() {
    ...
    return (
        <section className="w-full h-full relative flex justify-center py-10 overflow-x-hidden overflow-y-scroll">
            <div className="max-w-150 w-full h-full flex flex-col justify-center items-center mx-5">
                <header className="flex w-full justify-between items-center">
                    <h2 className="text-black font-serif sm:text-2xl text-md font-bold flex gap-2 place-items-center">
                        <button
